...
docker run --rm --name mongooseim-builder -h mongooseim-builder -e TARBALL_NAME=mongooseim -v "$(pwd)/builds:/builds" mongooseim-builder ./build.sh MongooseIM https://github.com/zextras/mongooseim 47c68935ea00ad0adeef88e6bffe1b108f22b0c5
